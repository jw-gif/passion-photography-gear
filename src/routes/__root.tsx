...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Track photography gear locations across 515, Cumberland, and Trilith." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Passion Gear Tracking" },
      { name: "twitter:description", content: "Track photography gear locations across 515, Cumberland, and Trilith." },
